...
const {gameDate,nextReset,selectedForDate}=require('../src/daily-core.js');
const points=JSON.parse(fs.readFileSync(path.join(root,'src/points.json'),'utf8'));
...
console.log('PASS: route labels, known day, 4000 dates, reset/DST boundaries, standalone image.');
